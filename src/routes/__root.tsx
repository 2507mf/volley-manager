...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vôlei Manager — Gestão da sua pelada de vôlei" },
      {
        name: "description",
        content:
          "Controle participantes, mensalidades, pagamentos e o caixa da sua pelada de vôlei.",
      },
      { property: "og:title", content: "Vôlei Manager" },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var t=localStorage.getItem('pelada-theme');if(t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme: dark)').matches)){document.documentElement.classList.add('dark')}}catch(e){}`,
          }}
        />
      </head>
